					...
					<div className="col-[content]">
						<Select.ItemGroup id="book" className="py-4">
							{items.map((item) => (
								...
								>
									<Select.ItemText className="after:[&:]:[content:'_'] relative text-sm leading-[1] after:absolute after:inset-x-0 after:-bottom-1 after:border-b-2 after:border-b-transparent after:transition after:duration-quick after:ease-in-out group-hover:after:border-b-current sm:text-base">
										{item.label}
									</Select.ItemText>
								</Select.Item>
							))}
