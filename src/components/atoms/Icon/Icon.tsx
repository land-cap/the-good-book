...
export const Icon = ({
	...
	const weightToCls = new Map<TIconWeight, string>([
		[100, '[--icon-weight:100]'],
		[200, '[--icon-weight:200]  dark:[--icon-weight:100]'],
		[300, '[--icon-weight:300]  dark:[--icon-weight:200]'],
		[400, '[--icon-weight:400] dark:[--icon-weight:300]'],
		[500, '[--icon-weight:500]  dark:[--icon-weight:400]'],
		[600, '[--icon-weight:600]  dark:[--icon-weight:500]'],
		[700, '[--icon-weight:700]  dark:[--icon-weight:600]'],
	])
