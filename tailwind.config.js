...
module.exports = {
	...
	theme: {
		extend: {
			...
			colors: {
				bgCanvas: 'var(--colors-bg-canvas)',
				bgSurface: 'var(--colors-bg-surface)',
				bgSubtle: 'var(--colors-bg-subtle)',
				bgMuted: 'var(--colors-bg-muted)',
				fg: 'var(--colors-fg)',
				fgEmphasized: 'var(--colors-fg-emphasized)',
				fgMuted: 'var(--colors-fg-muted)',
				fgSubtle: 'var(--colors-fg-subtle)',
				fgFaded: 'var(--colors-fg-faded)',
				fgInverted: 'var(--colors-fg-inverted)',
