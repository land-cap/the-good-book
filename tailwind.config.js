...
module.exports = {
	...
	theme: {
		extend: {
			...
			colors: {
				bgCanvas: 'var(--colors-white)',
				bgSurface: 'var(--colors-white)',
				bgSubtle: 'var(--colors-neutral-50)',
				bgMuted: 'var(--colors-neutral-100)',
				fg: 'var(--colors-neutral-900)',
				fgEmphasized: 'var(--colors-neutral-700)',
				fgMuted: 'var(--colors-neutral-600)',
				fgSubtle: 'var(--colors-neutral-500)',
				fgFaded: 'var(--colors-neutral-400)',
				fgInverted: 'var(--colors-white)',
				border: 'var(--colors-neutral-200)',
				borderEmphasized: 'var(--colors-neutral-300)',
			},
			fontFamily: {
				sans: ['var(--font-sans)'],
				mono: ['var(--font-mono)'],
